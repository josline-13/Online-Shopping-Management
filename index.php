...
<section>
    ...
    <form action="login.php" method="post">
        <h1>LOGIN FORM</h1>
        <h3><input type="email" name="email" placeholder="Enter valid email" required>
        <h3><input type="password"  name="pass" placeholder="Password" required>
        <h3><input type="submit" name="" value="Login"><br><center>
        <a href="signup.php">Register Here</a></center>
